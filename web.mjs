...
(function ($) {
    class $koplenov_reactor extends $mol_book2_catalog {
        ...
        text(id) {
            ...
            obj.enabled = () => false;
            obj.value = () => this.content(id);
            return obj;
        }
    }
    __decorate([
        $mol_mem_key
    ], $koplenov_reactor.prototype, "PeopleView", null);
    __decorate([
        $mol_mem
    ], $koplenov_reactor.prototype, "Themme", null);
    __decorate([
        $mol_mem
...
//koplenov/reactor/-view.tree/reactor.view.tree.ts
;
"use strict";
var $;
(function ($) {
    var $$;
    (function ($$) {
        class $koplenov_reactor extends $.$koplenov_reactor {
            peoples() {
            ...
            peoples_view() {
                return this.peoples().map((people) => this.PeopleView(people));
            }
            people_name(people) {
        ...
        __decorate([
            $mol_mem
        ], $koplenov_reactor.prototype, "peoples", null);
        __decorate([
            $mol_mem_key
        ], $koplenov_reactor.prototype, "content", null);
        __decorate([
            $mol_mem
        ], $koplenov_reactor.prototype, "peoples_view", null);
        __decorate([
            $mol_mem_key
        ], $koplenov_reactor.prototype, "people_name", null);
        $$.$koplenov_reactor = $koplenov_reactor;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
